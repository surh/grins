...
GRINS_file=open("OLMS_GRINS_list.txt",'w')
...
GRINS_file.write("Manually attributed some small regions detected as GRINS, to be possible/erased GRINSs\n")
region_starts.remove(269)
region_ends.remove(290)
region_starts.remove(943)
region_ends.remove(960)
region_starts.remove(1120)
region_ends.remove(1124)
region_starts.remove(1125)
region_ends.remove(1144)
region_starts.remove(1327)
region_ends.remove(1330)
region_starts.remove(1331)
region_ends.remove(1353)
region_starts.remove(2351)
region_ends.remove(2368)
possible_region_starts=[269,943,1120,1327,2351]
possible_region_ends=[290,960,1144,1353,2368]

### OLMS skew values ###

# Reading the GenBank file
record = SeqIO.read("OLMS.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in OLMS"
    GRINS_file.write("No GRINS found in OLMS")
else:
    ...
    GRINS_file.write("found following GRINS in OLMS:\n")
with open("OLMS_GRINS.gb","w") as annotated_file:
...
plt.savefig("OLMS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("OLMS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("OLMS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_OLMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_OLMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_OLMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_OLMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_OLMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_OLMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_OLMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_OLMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_OLMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_OLMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_OLMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_OLMS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_OLMS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_OLMS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_OLMS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_OLMS_rest.png")
...
plt.savefig("./Content_nt/OLMS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/OLMS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/OLMS_GC_content.png")
