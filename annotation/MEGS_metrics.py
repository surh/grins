...
GRINS_file=open("MEGS_GRINS_list.txt",'w')
...
# possible_region_starts=[250,293,351,455,610,844,910,949,1073,1180,1216,1326,1396]
# possible_region_ends=[274,334,362,487,640,883,914,1000,1120,1197,1230,1375,len(similarity_max_array)-1]
# region_starts=[]
# region_ends=[]
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in MEGS"
    GRINS_file.write("No GRINS found in MEGS")
else:
    ...
    GRINS_file.write("found following GRINS in MEGS:\n")
with open("MEGS_GRINS.gb","w") as annotated_file:
...
plt.savefig("MEGS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("MEGS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("MEGS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MEGS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MEGS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MEGS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MEGS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MEGS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MEGS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MEGS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MEGS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MEGS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MEGS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MEGS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MEGS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MEGS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MEGS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MEGS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MEGS_rest.png")
...
plt.savefig("./Content_nt/MEGS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/MEGS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/MEGS_GC_content.png")
