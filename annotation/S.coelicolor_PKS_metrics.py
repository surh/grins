...
GRINS_file=open("S.coelicolor_PKS_GRINS_list.txt",'w')
...
### S.coelicolor_PKS alignmemt scores ###

# Getting  scores for S.coelicolor_PKS alignment to itself
with open("./S.coelicolor_PKS_vs_S.coelicolor_PKS_window150_step30_1x1.txt", 'r') as input_file1:
	input_data1=input_file1.readlines()
for i in range(0,len(input_data1)):
	line=input_data1[i].split(",")
	input_data1[i]=line[:-1]      
with open("./S.coelicolor_PKS_vs_S.coelicolor_PKS_window150_step30_1x2.txt", 'r') as input_file2:
	input_data2=input_file2.readlines()
for i in range(0,len(input_data2)):
	line=input_data2[i].split(",")
	input_data2[i]=line[:-1]
with open("./S.coelicolor_PKS_vs_S.coelicolor_PKS_window150_step30_1x3.txt", 'r') as input_file3:
	input_data3=input_file3.readlines()
for i in range(0,len(input_data3)):
	line=input_data3[i].split(",")
	input_data3[i]=line[:-1]
with open("./S.coelicolor_PKS_vs_S.coelicolor_PKS_window150_step30_2x2.txt", 'r') as input_file4:
	input_data4=input_file4.readlines()
for i in range(0,len(input_data4)):
	line=input_data4[i].split(",")
	input_data4[i]=line[:-1]
with open("./S.coelicolor_PKS_vs_S.coelicolor_PKS_window150_step30_2x3.txt", 'r') as input_file5:
	input_data5=input_file5.readlines()
for i in range(0,len(input_data5)):
	line=input_data5[i].split(",")
	input_data5[i]=line[:-1]
with open("./S.coelicolor_PKS_vs_S.coelicolor_PKS_window150_step30_3x3.txt", 'r') as input_file6:
...
# GRINS_file.write("Manually added a few GRINSs\n")
# region_starts.append(30)
# region_ends.append(50)
# region_starts.append(1300)
# region_ends.append(1330)
# region_starts.append(1570)
# region_ends.append(1600)
#
# region_starts.sort()
# region_ends.sort()
...
### S.coelicolor_PKS skew values ###

# Reading the GenBank file
record = SeqIO.read("S.coelicolor_PKS.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in S.coelicolor_PKS"
    GRINS_file.write("No GRINS found in S.coelicolor_PKS")
else:
    ...
    GRINS_file.write("found following GRINS in S.coelicolor_PKS:\n")
with open("S.coelicolor_PKS_GRINS.gb","w") as annotated_file:
...
plt.savefig("S.coelicolor_PKS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("S.coelicolor_PKS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("S.coelicolor_PKS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_S.coelicolor_PKS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_S.coelicolor_PKS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_S.coelicolor_PKS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_S.coelicolor_PKS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_S.coelicolor_PKS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_S.coelicolor_PKS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_S.coelicolor_PKS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_S.coelicolor_PKS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_S.coelicolor_PKS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_S.coelicolor_PKS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_S.coelicolor_PKS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_S.coelicolor_PKS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_S.coelicolor_PKS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_S.coelicolor_PKS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_S.coelicolor_PKS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_S.coelicolor_PKS_rest.png")
...
plt.savefig("./Content_nt/S.coelicolor_PKS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/S.coelicolor_PKS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/S.coelicolor_PKS_GC_content.png")
