...
GRINS_file=open("DEBS_PKS11_GRINS_list.txt",'w')
...
### DEBS_PKS11 skew values ###

# Reading the GenBank file
record = SeqIO.read("DEBS_PKS11.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in DEBS_PKS11"
    GRINS_file.write("No GRINS found in DEBS_PKS11")
else:
    ...
    GRINS_file.write("found following GRINS in DEBS_PKS11:\n")
with open("DEBS_PKS11_GRINS.gb","w") as annotated_file:
...
plt.savefig("DEBS_PKS11_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("DEBS_PKS11_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("DEBS_PKS11_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_DEBS_PKS11_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_DEBS_PKS11_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_DEBS_PKS11_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_DEBS_PKS11_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_DEBS_PKS11_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_DEBS_PKS11_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_DEBS_PKS11_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_DEBS_PKS11_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_DEBS_PKS11_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_DEBS_PKS11_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_DEBS_PKS11_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_DEBS_PKS11_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_DEBS_PKS11_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_DEBS_PKS11_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_DEBS_PKS11_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_DEBS_PKS11_rest.png")
...
plt.savefig("./Content_nt/DEBS_PKS11_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/DEBS_PKS11_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/DEBS_PKS11_GC_content.png")
