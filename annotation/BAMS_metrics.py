...
GRINS_file=open("BAMS_GRINS_list.txt",'w')
...
# region_starts.append(value1)
# GRINS_file.write("Manually added region end at "+str(*30))
# region_ends.append()
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in BAMS"
    GRINS_file.write("No GRINS found in BAMS")
else:
    ...
    GRINS_file.write("found following GRINS in BAMS:\n")
with open("BAMS_GRINS.gb","w") as annotated_file:
...
plt.savefig("BAMS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("BAMS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("BAMS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_BAMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_BAMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_BAMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_BAMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_BAMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_BAMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_BAMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_BAMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_BAMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_BAMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_BAMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_BAMS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_BAMS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_BAMS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_BAMS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_BAMS_rest.png")
...
plt.savefig("./Content_nt/BAMS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/BAMS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/BAMS_GC_content.png")
