...
GRINS_file=open("CONS_GRINS_list.txt",'w')
...
GRINS_file.write("Manually deleted ten last detected regions, and assigned them as possible GRINS regions\n")
possible_region_starts=region_starts[-10:]
possible_region_ends=region_ends[-10:]

region_starts=region_starts[:-10]
region_ends=region_ends[:-10]


### CONS skew values ###

# Reading the GenBank file
record = SeqIO.read("CONS.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in CONS"
    GRINS_file.write("No GRINS found in CONS")
else:
    ...
    GRINS_file.write("found following GRINS in CONS:\n")
with open("CONS_GRINS.gb","w") as annotated_file:
...
plt.savefig("CONS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("CONS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("CONS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_CONS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_CONS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_CONS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_CONS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_CONS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_CONS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_CONS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_CONS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_CONS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_CONS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_CONS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_CONS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_CONS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_CONS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_CONS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_CONS_rest.png")
...
plt.savefig("./Content_nt/CONS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/CONS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/CONS_GC_content.png")
