...
GRINS_file=open("MLSS_GRINS_list.txt",'w')
...
GRINS_file.write("Manually added an end to one of the  GRINSs:\n")
region_ends.append (len(similarity_max_array)-1)
region_ends.sort()

### MLSS skew values ###

# Reading the GenBank file
record = SeqIO.read("MLSS.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in MLSS"
    GRINS_file.write("No GRINS found in MLSS")
else:
    ...
    GRINS_file.write("found following GRINS in MLSS:\n")
with open("MLSS_GRINS.gb","w") as annotated_file:
...
plt.savefig("MLSS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("MLSS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("MLSS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MLSS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MLSS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MLSS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MLSS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MLSS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MLSS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MLSS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MLSS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MLSS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MLSS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MLSS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MLSS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MLSS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MLSS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MLSS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MLSS_rest.png")
...
plt.savefig("./Content_nt/MLSS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/MLSS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/MLSS_GC_content.png")
