...
GRINS_file=open("MILS_GRINS_list.txt",'w')
...
possible_region_starts=[100,870,1278,1430,1660,1780]
possible_region_ends=[220,930,1320,1500,1759,1860]
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in MILS"
    GRINS_file.write("No GRINS found in MILS")
else:
    ...
    GRINS_file.write("found following GRINS in MILS:\n")
with open("MILS_GRINS.gb","w") as annotated_file:
...
plt.savefig("MILS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("MILS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("MILS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MILS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MILS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MILS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MILS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MILS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MILS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MILS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MILS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MILS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MILS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MILS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MILS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MILS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MILS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MILS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MILS_rest.png")
...
plt.savefig("./Content_nt/MILS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/MILS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/MILS_GC_content.png")
...
# plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
# plt.legend(["Maximum identity %"],loc=4)
plt.savefig("MILS_GCskew_TAskew.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("MILS_GCskew_TAskew_similarity_only_GRINS.png")
