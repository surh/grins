...
GRINS_file=open("RAPS_GRINS_list.txt",'w')
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in RAPS"
    GRINS_file.write("No GRINS found in RAPS")
else:
    ...
    GRINS_file.write("found following GRINS in RAPS:\n")
with open("RAPS_GRINS.gb","w") as annotated_file:
...
plt.savefig("RAPS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("RAPS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("RAPS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_RAPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_RAPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_RAPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_RAPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_RAPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_RAPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_RAPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_RAPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_RAPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_RAPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_RAPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_RAPS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_RAPS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_RAPS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_RAPS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_RAPS_rest.png")
...
plt.savefig("./Content_nt/RAPS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/RAPS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/RAPS_GC_content.png")
