...
GRINS_file=open("NMDS_GRINS_list.txt",'w')
...
### NMDS alignmemt scores ###

# Getting  scores for NMDS alignment to itself
with open("./NMDS_vs_NMDS_window150_step30_1x1.txt", 'r') as input_file1:
	input_data1=input_file1.readlines()
for i in range(0,len(input_data1)):
	line=input_data1[i].split(",")
	input_data1[i]=line[:-1]      
with open("./NMDS_vs_NMDS_window150_step30_1x2.txt", 'r') as input_file2:
	input_data2=input_file2.readlines()
for i in range(0,len(input_data2)):
	line=input_data2[i].split(",")
	input_data2[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_1x3.txt", 'r') as input_file3:
	input_data3=input_file3.readlines()
for i in range(0,len(input_data3)):
	line=input_data3[i].split(",")
	input_data3[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_1x4.txt", 'r') as input_file4:
	input_data4=input_file4.readlines()
for i in range(0,len(input_data4)):
	line=input_data4[i].split(",")
	input_data4[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_1x5.txt", 'r') as input_file5:
	input_data5=input_file5.readlines()
for i in range(0,len(input_data5)):
	line=input_data5[i].split(",")
	input_data5[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_2x2.txt", 'r') as input_file6:
	input_data6=input_file6.readlines()
for i in range(0,len(input_data6)):
	line=input_data6[i].split(",")
	input_data6[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_2x3.txt", 'r') as input_file7:
	input_data7=input_file7.readlines()
for i in range(0,len(input_data7)):
	line=input_data7[i].split(",")
	input_data7[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_2x4.txt", 'r') as input_file8:
	input_data8=input_file8.readlines()
for i in range(0,len(input_data8)):
	line=input_data8[i].split(",")
	input_data8[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_2x5.txt", 'r') as input_file9:
	input_data9=input_file9.readlines()
for i in range(0,len(input_data9)):
	line=input_data9[i].split(",")
	input_data9[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_3x3.txt", 'r') as input_file10:
	input_data10=input_file10.readlines()
for i in range(0,len(input_data10)):
	line=input_data10[i].split(",")
	input_data10[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_3x4.txt", 'r') as input_file11:
	input_data11=input_file11.readlines()
for i in range(0,len(input_data11)):
	line=input_data11[i].split(",")
	input_data11[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_3x5.txt", 'r') as input_file12:
	input_data12=input_file12.readlines()
for i in range(0,len(input_data12)):
	line=input_data12[i].split(",")
	input_data12[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_4x4.txt", 'r') as input_file13:
	input_data13=input_file13.readlines()
for i in range(0,len(input_data13)):
	line=input_data13[i].split(",")
	input_data13[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_4x5.txt", 'r') as input_file14:
	input_data14=input_file14.readlines()
for i in range(0,len(input_data14)):
	line=input_data14[i].split(",")
	input_data14[i]=line[:-1]
with open("./NMDS_vs_NMDS_window150_step30_5x5.txt", 'r') as input_file15:
	input_data15=input_file15.readlines()
for i in range(0,len(input_data15)):
	line=input_data15[i].split(",")
	input_data15[i]=line[:-1]

input_data2_transposeed=transpose_matrix(input_data2)
input_data3_transposeed=transpose_matrix(input_data3)
input_data4_transposeed=transpose_matrix(input_data4)
input_data5_transposeed=transpose_matrix(input_data5)

input_data7_transposeed=transpose_matrix(input_data7)
input_data8_transposeed=transpose_matrix(input_data8)
input_data9_transposeed=transpose_matrix(input_data9)

input_data11_transposeed=transpose_matrix(input_data11)
input_data12_transposeed=transpose_matrix(input_data12)

input_data14_transposeed=transpose_matrix(input_data14)
...
for i in range(0,len(input_data2_transposeed)):
	homology_matrix.append([])
	line_data2=input_data2_transposeed[i]
	line_data6=input_data6[i]
	line_data7=input_data7[i]
	line_data8=input_data8[i]
	line_data9=input_data9[i]
	for j in range(0,len(line_data2)):
		homology_matrix[len(homology_matrix)-1].append(float(line_data2[j])/1.5)
	for j in range(0,len(line_data6)):
		homology_matrix[len(homology_matrix)-1].append(float(line_data6[j])/1.5)
	for j in range(0,len(line_data7)):
		homology_matrix[len(homology_matrix)-1].append(float(line_data7[j])/1.5)
	for j in range(0,len(line_data8)):
		homology_matrix[len(homology_matrix)-1].append(float(line_data8[j])/1.5)
	for j in range(0,len(line_data9)):
		homology_matrix[len(homology_matrix)-1].append(float(line_data9[j])/1.5)
for i in range(0,len(input_data3_transposeed)):
 	homology_matrix.append([])
	line_data3=input_data3_transposeed[i]
	line_data7=input_data7_transposeed[i]
	line_data10=input_data10[i]
	line_data11=input_data11[i]
	line_data12=input_data12[i]
 	for j in range(0,len(line_data3)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data3[j])/1.5)
 	for j in range(0,len(line_data7)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data7[j])/1.5)
 	for j in range(0,len(line_data10)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data10[j])/1.5)   
 	for j in range(0,len(line_data11)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data11[j])/1.5)
 	for j in range(0,len(line_data12)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data12[j])/1.5)
for i in range(0,len(input_data4_transposeed)):
 	homology_matrix.append([])
	line_data4=input_data4_transposeed[i]
	line_data8=input_data8_transposeed[i]
	line_data11=input_data11_transposeed[i]
	line_data13=input_data13[i]
	line_data14=input_data14[i]
 	for j in range(0,len(line_data4)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data4[j])/1.5)
 	for j in range(0,len(line_data8)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data8[j])/1.5)
 	for j in range(0,len(line_data11)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data11[j])/1.5)   
 	for j in range(0,len(line_data13)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data13[j])/1.5)
 	for j in range(0,len(line_data14)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data14[j])/1.5)
for i in range(0,len(input_data5_transposeed)):
 	homology_matrix.append([])
	line_data5=input_data5_transposeed[i]
	line_data9=input_data9_transposeed[i]
	line_data12=input_data12_transposeed[i]
	line_data14=input_data14_transposeed[i]
	line_data15=input_data15[i]
 	for j in range(0,len(line_data5)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data5[j])/1.5)
 	for j in range(0,len(line_data9)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data9[j])/1.5)
 	...
 	for j in range(0,len(line_data14)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data14[j])/1.5)
 	for j in range(0,len(line_data15)):
 		homology_matrix[len(homology_matrix)-1].append(float(line_data15[j])/1.5)     
...
GRINS_file.write("Manually assigned all regions non detected as GRINS, to be erased/possible GRINSs (GRINS?)\n")
for i in range(0,len(region_ends)-1):
    possible_region_starts.append(region_ends[i])
    possible_region_ends.append(region_starts[i+1])
possible_region_starts.append(region_ends[len(region_ends)-1])
possible_region_ends.append(len(similarity_max_array))


### NMDS skew values ###

# Reading the GenBank file
record = SeqIO.read("NMDS.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in NMDS"
    GRINS_file.write("No GRINS found in NMDS")
else:
    ...
    GRINS_file.write("found following GRINS in NMDS:\n")
with open("NMDS_GRINS.gb","w") as annotated_file:
...
plt.savefig("NMDS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("NMDS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("NMDS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_NMDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_NMDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_NMDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_NMDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_NMDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_NMDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_NMDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_NMDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_NMDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_NMDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_NMDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_NMDS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_NMDS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_NMDS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_NMDS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_NMDS_rest.png")
...
plt.savefig("./Content_nt/NMDS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/NMDS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/NMDS_GC_content.png")
