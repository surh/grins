...
GRINS_file=open("PLDS_GRINS_list.txt",'w')
...
GRINS_file.write("Manually added a few possible GRINSs\n")
possible_region_starts.append(30)
possible_region_ends.append(50)
possible_region_starts.append(1300)
possible_region_ends.append(1330)
possible_region_starts.append(1570)
possible_region_ends.append(1600)
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in PLDS"
    GRINS_file.write("No GRINS found in PLDS")
else:
    ...
    GRINS_file.write("found following GRINS in PLDS:\n")
with open("PLDS_GRINS.gb","w") as annotated_file:
...
plt.savefig("PLDS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("PLDS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("PLDS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_PLDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_PLDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_PLDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_PLDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_PLDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_PLDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_PLDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_PLDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_PLDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_PLDS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_PLDS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_PLDS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_PLDS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_PLDS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_PLDS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_PLDS_rest.png")
...
plt.savefig("./Content_nt/PLDS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/PLDS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/PLDS_GC_content.png")
