...
GRINS_file=open("NORS_GRINS_list.txt",'w')
...
GRINS_file.write("Manually attributed all found GRINSs to be erased/possible GRINSs (GRINS?)\n")
possible_region_starts=region_starts
possible_region_ends=region_ends
region_starts=[]
region_ends=[]
GRINS_file.write("Manually added erased/possible GRINSs (GRINS?):\n")
possible_region_starts.append(51)
possible_region_ends.append(100)
possible_region_starts.append(235)
possible_region_ends.append(270)
possible_region_starts.append(816)
possible_region_ends.append(845)

### NORS skew values ###

# Reading the GenBank file
record = SeqIO.read("NORS.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in NORS"
    GRINS_file.write("No GRINS found in NORS")
else:
    ...
    GRINS_file.write("found following GRINS in NORS:\n")
with open("NORS_GRINS.gb","w") as annotated_file:
...
plt.savefig("NORS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("NORS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("NORS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_NORS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_NORS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_NORS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_NORS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_NORS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_NORS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_NORS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_NORS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_NORS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_NORS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_NORS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_NORS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_NORS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_NORS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_NORS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_NORS_rest.png")
...
plt.savefig("./Content_nt/NORS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/NORS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/NORS_GC_content.png")
