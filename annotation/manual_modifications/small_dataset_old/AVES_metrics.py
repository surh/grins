...
GRINS_file=open("AVES_GRINS_list.txt",'w')
...
GRINS_file.write("Manually added a possible GRINS region at "+str(1660*30)+"-"+str(1710*30)+"\n")
possible_region_starts.append(1660)
possible_region_ends.append(1710)
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in AVES"
    GRINS_file.write("No GRINS found in AVES")
else:
    ...
    GRINS_file.write("found following GRINS in AVES:\n")
with open("AVES_GRINS.gb","w") as annotated_file:
...
plt.savefig("AVES_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("AVES_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("AVES_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_AVES_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_AVES_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_AVES_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_AVES_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_AVES_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_AVES_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_AVES_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_AVES_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_AVES_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_AVES_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_AVES_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_AVES_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_AVES_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_AVES_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_AVES_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_AVES_rest.png")
...
plt.savefig("./Content_nt/AVES_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/AVES_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/AVES_GC_content.png")
