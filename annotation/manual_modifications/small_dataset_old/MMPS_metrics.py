...
GRINS_file=open("MMPS_GRINS_list.txt",'w')
...
GRINS_file.write("Manually assigned detected GRINSs (based on sequence similarity) to erased/possible GRINSs (GRINS?)\n")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in MMPS"
    GRINS_file.write("No GRINS found in MMPS")
else:
    ...
    GRINS_file.write("found following GRINS in MMPS:\n")
with open("MMPS_GRINS.gb","w") as annotated_file:
...
plt.savefig("MMPS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("MMPS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("MMPS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MMPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MMPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MMPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MMPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MMPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MMPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MMPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MMPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MMPS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MMPS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MMPS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MMPS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MMPS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MMPS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MMPS_rest.png")
...
plt.savefig("./Content_nt/MMPS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/MMPS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/MMPS_GC_content.png")
