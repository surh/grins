...
GRINS_file=open("MERS_GRINS_list.txt",'w')
...
GRINS_file.write(str(358*30)+"-"+str(434*30)+"(erased/possible GRINS)\n")
GRINS_file.write(str(683*30)+"-"+str(720*30)+"(erased/possible GRINS)\n")
possible_region_starts=[358,683]
possible_region_ends=[434,720]
# region_starts=[]
# region_ends=[]
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in MERS"
    GRINS_file.write("No GRINS found in MERS")
else:
    ...
    GRINS_file.write("found following GRINS in MERS:\n")
with open("MERS_GRINS.gb","w") as annotated_file:
...
plt.savefig("MERS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("MERS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("MERS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MERS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_MERS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MERS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_MERS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MERS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_MERS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MERS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_MERS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MERS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_MERS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MERS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_MERS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MERS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_MERS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MERS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_MERS_rest.png")
...
plt.savefig("./Content_nt/MERS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/MERS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/MERS_GC_content.png")
