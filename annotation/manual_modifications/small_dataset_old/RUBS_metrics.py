...
GRINS_file=open("RUBS_GRINS_list.txt",'w')
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in RUBS"
    GRINS_file.write("No GRINS found in RUBS")
else:
    ...
    GRINS_file.write("found following GRINS in RUBS:\n")
with open("RUBS_GRINS.gb","w") as annotated_file:
...
plt.savefig("RUBS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("RUBS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("RUBS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_RUBS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_RUBS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_RUBS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_RUBS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_RUBS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_RUBS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_RUBS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_RUBS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_RUBS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_RUBS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_RUBS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_RUBS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_RUBS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_RUBS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_RUBS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_RUBS_rest.png")
...
plt.savefig("./Content_nt/RUBS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/RUBS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/RUBS_GC_content.png")
