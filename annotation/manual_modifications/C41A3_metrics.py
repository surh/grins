...
GRINS_file=open("C41A3_1a_GRINS_list.txt",'w')
...
### C41A3_1a alignmemt scores ###

# Getting  scores for C41A3_1a alignment to itself
with open("./C41A3_1a_vs_C41A3_1a_with_introns_window150_step30_1x1.txt", 'r') as input_file1:
	input_data1=input_file1.readlines()
for i in range(0,len(input_data1)):
	line=input_data1[i].split(",")
	input_data1[i]=line[:-1]      
with open("./C41A3_1a_vs_C41A3_1a_with_introns_window150_step30_1x2.txt", 'r') as input_file2:
	input_data2=input_file2.readlines()
for i in range(0,len(input_data2)):
	line=input_data2[i].split(",")
	input_data2[i]=line[:-1]
with open("./C41A3_1a_vs_C41A3_1a_with_introns_window150_step30_1x3.txt", 'r') as input_file3:
	input_data3=input_file3.readlines()
for i in range(0,len(input_data3)):
	line=input_data3[i].split(",")
	input_data3[i]=line[:-1]
with open("./C41A3_1a_vs_C41A3_1a_with_introns_window150_step30_2x2.txt", 'r') as input_file4:
	input_data4=input_file4.readlines()
for i in range(0,len(input_data4)):
	line=input_data4[i].split(",")
	input_data4[i]=line[:-1]
with open("./C41A3_1a_vs_C41A3_1a_with_introns_window150_step30_2x3.txt", 'r') as input_file5:
	input_data5=input_file5.readlines()
for i in range(0,len(input_data5)):
	line=input_data5[i].split(",")
	input_data5[i]=line[:-1]
with open("./C41A3_1a_vs_C41A3_1a_with_introns_window150_step30_3x3.txt", 'r') as input_file6:
...
### C41A3_1a skew values ###

# Reading the GenBank file
record = SeqIO.read("C41A3_with_introns.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in C41A3_1a"
    GRINS_file.write("No GRINS found in C41A3_1a")
else:
    ...
    GRINS_file.write("found following GRINS in C41A3_1a:\n")
with open("C41A3_1a_GRINS.gb","w") as annotated_file:
...
plt.savefig("C41A3_1a_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("C41A3_1a_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("C41A3_1a_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_C41A3_1a_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_C41A3_1a_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_C41A3_1a_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_C41A3_1a_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_C41A3_1a_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_C41A3_1a_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_C41A3_1a_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_C41A3_1a_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_C41A3_1a_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_C41A3_1a_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_C41A3_1a_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_C41A3_1a_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_C41A3_1a_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_C41A3_1a_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_C41A3_1a_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_C41A3_1a_rest.png")
...
plt.savefig("./Content_nt/C41A3_1a_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/C41A3_1a_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/C41A3_1a_GC_content.png")
