...
GRINS_file=open("HBMS_GRINS_list.txt",'w')
...
possible_region_starts=[250,310,399,607,841,945,1214,1279,1326]
possible_region_ends=[266,332,485,650,878,1000,1252,1286,len(similarity_max_array)-1]
# region_starts=[]
# region_ends=[]
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in HBMS"
    GRINS_file.write("No GRINS found in HBMS")
else:
    ...
    GRINS_file.write("found following GRINS in HBMS:\n")
with open("HBMS_GRINS.gb","w") as annotated_file:
...
plt.savefig("HBMS_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("HBMS_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("HBMS_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_HBMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_HBMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_HBMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_HBMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_HBMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_HBMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_HBMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_HBMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_HBMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_HBMS_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_HBMS_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_HBMS_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_HBMS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_HBMS_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_HBMS_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_HBMS_rest.png")
...
plt.savefig("./Content_nt/HBMS_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/HBMS_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/HBMS_GC_content.png")
