...
GRINS_file=open("FK520S_GRINS_list.txt",'w')
...
# GRINS_file.write("Manually added the end of the last GRINS at 1800 (54000)\n")
# region_ends.append(1800)


### FK520S skew values ###

# Reading the GenBank file
record = SeqIO.read("FK520S.gb", "gb")
...
if len(region_starts)!=len(region_ends):
    ...
    print "No GRINS found in FK520S"
    GRINS_file.write("No GRINS found in FK520S")
else:
    ...
    GRINS_file.write("found following GRINS in FK520S:\n")
with open("FK520S_GRINS.gb","w") as annotated_file:
...
plt.savefig("FK520S_GCskew_TAskew_identity.png")
...
plt.plot(a2,similarity_max_array,color="black",linewidth=0.5)
plt.legend(["Maximum identity %"],loc=4)
plt.savefig("FK520S_GCskew_ATskew_identity.png")
...
if len(region_starts)!=0 and len(region_ends)!=0:
    ...
    skew_corr_file=open("FK520S_composition_and_skew_values.txt",'w')
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_FK520S_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_C_FK520S_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_FK520S_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_A_FK520S_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_FK520S_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_G_T_FK520S_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_FK520S_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_C_FK520S_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_FK520S_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_C_T_FK520S_rest.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_FK520S_GRINS.png")
    ...
    plt.savefig("./Correlation_nt/Correlation_A_T_FK520S_rest.png")
    ...
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_FK520S_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_TA_skews_FK520S_rest.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_FK520S_GRINS.png")
    ...
    ax1.text(-1,0.6,"r="+str(np.round(r_value,2))+p_value_def(p_value), fontdict=font)
    plt.savefig("./Correlation_skews/Correlation_GC_AT_skews_FK520S_rest.png")
...
plt.savefig("./Content_nt/FK520S_nucleotide_G_C_content.png")
...
plt.savefig("./Content_nt/FK520S_nucleotide_A_T_content.png")
...
plt.savefig("./Content_nt/FK520S_GC_content.png")
